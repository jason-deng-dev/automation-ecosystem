...
VALUES
    ...
    ('Fitness Machines', ARRAY[565772, 201866, 201867, 204690, 204695, 565861, 565863, 565864], 2),
    ...
    ('Reflective Vest', ARRAY[101870, 204173, 206366, 303544, 402104, 563163, 563183, 566771], 1),
    ...
    ('Dumbbell', ARRAY[205054, 503299], 2),
    ('Treadmill', ARRAY[205052], 2),
    ('Balance Ball', ARRAY[201868, 204697, 302620, 302623], 2),
